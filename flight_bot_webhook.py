...
async def language_chosen(update: Update, context: CallbackContext.DEFAULT_TYPE):
...
async def from_city(update: Update, context: CallbackContext.DEFAULT_TYPE):
...
async def choose_from(update: Update, context: CallbackContext.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
...
async def to_city(update: Update, context: CallbackContext.DEFAULT_TYPE):
    token = get_amadeus_token()
    cities = get_city_options(update.message.text, token)
    if not cities:
        await update.message.reply_text("City not found. Please try again.")
...
async def choose_to(update: Update, context: CallbackContext.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
...
async def trip_type(update: Update, context: CallbackContext.DEFAULT_TYPE):
...
async def departure_date(update: Update, context: CallbackContext.DEFAULT_TYPE):
...
async def return_date(update: Update, context: CallbackContext.DEFAULT_TYPE):
    user_data[update.message.from_user.id]["return_date"] = update.message.text
    return await show_flights(update, context)

async def show_flights(update: Update, context: CallbackContext.DEFAULT_TYPE):
